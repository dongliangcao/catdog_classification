...
def train(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        for i, (imgs, target) in enumerate(train_loader):
            ...
            optimizer.step()
            # log
            logger.add_scalar('train_loss', loss, global_step=epoch*len(train_loader)+i)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_every_epoch', help='the frequency of model saving (default: 1)', type=int, default=1)
